// Real-time MPC controller with Kalman Filter to Double-Tank Process
//=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=//
// declarations 
...
//--------------------------------------------------------------------//
// Plat configuration
    const Ap = [[0.9843, 0], [0.2498, 0.9932]]; // matrix 2x2
    const Bp = [[0.2048], [0.0259]]; // matrix 2x1
    const Cp = [[0, 0.25]];// matrix 1x2
    const Dp = [0]; // matrix 1x1
    var Np = 50; // Prediction horizen
    var Nc = 5; // Control horizen
    var n = 2, m = 1, k = 1;// n=>number of states, k=>number of inputs, m=>number of outputs
    ...
    var ref = 15;// 0 - 1 cm scaled from 0 - 27 cm
...
// limitations of input and output
    var delta_U_min = -1;
    var delta_U_max = 1;
    var u_min = 0;
    var u_max = 1;
...
//====================================================================================
/* For Reading the Value form the Level Sensor */
function readLevel(){
